...
> Note: This project is no longer in active development or support; it is superseded by the [Pi Remind HD Notify](https://github.com/johnwargo/pi-remind-hd-notify) project. Please use the new version instead.
